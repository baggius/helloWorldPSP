...
int main(int argc, char* argv[])
{
	...
	GU_PSM_5650	< Pixelformat R5:G6:B5:A0.
	GU_PSM_5551	< Pixelformat R5:G5:B5:A1.
	GU_PSM_4444	< Pixelformat R4:G4:B4:A4.
	GU_PSM_8888	< Pixelformat R8:G8:B8:A8.
	GU_PSM_T4	< Pixelformat 4bit indexed.
	GU_PSM_T8	< Pixelformat 8bit indexed.
	GU_PSM_T16	< Pixelformat 16bit indexed.
	GU_PSM_T32	< Pixelformat 32bit indexed.
	GU_PSM_DXT1	< Pixelformat DXT1 compressed.
	GU_PSM_DXT3	< Pixelformat DXT3 compressed.
	GU_PSM_DXT5	< Pixelformat DXT5 compressed.

	*/

//	void* fbp0 = getStaticVramBuffer(BUF_WIDTH,SCR_HEIGHT,GU_PSM_8888); /* draw video buffer */
//	void* fbp1 = getStaticVramBuffer(BUF_WIDTH,SCR_HEIGHT,GU_PSM_8888); /* display video buffer */
//	void* zbp = getStaticVramBuffer(BUF_WIDTH,SCR_HEIGHT,GU_PSM_4444);  /* depth buffer */

	void* fbp0 = getStaticVramBuffer(BUF_WIDTH,SCR_HEIGHT,GU_PSM_4444); /* 16 bit draw video buffer */
	void* fbp1 = getStaticVramBuffer(BUF_WIDTH,SCR_HEIGHT,GU_PSM_4444); /* 16 bit display video buffer */
	void* zbp = getStaticVramBuffer(BUF_WIDTH,SCR_HEIGHT,GU_PSM_4444);  /* 16 bit depth buffer */
...
//		unsigned short* row = &pixels[y * BUF_WIDTH];
		unsigned short* row = &swizzled_pixels[y * BUF_WIDTH];
